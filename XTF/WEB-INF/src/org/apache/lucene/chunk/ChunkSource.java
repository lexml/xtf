...
public class ChunkSource 
{
  ...
  protected final DocNumMap docNumMap;

  /** The main document number */
  protected final int mainDocNum;
  ...
  protected final int chunkBump;

  /** First chunk in the document */
  protected final int firstChunk;

  /** Last chunk in the document */
  protected final int lastChunk;
  ...
  protected final LinkedList chunkCache = new LinkedList();

  /** Max # of chunks to cache */
  protected final int chunkCacheSize = 10;
  ...
  public Chunk loadChunk(int chunkNum) 
  {
    ...
    try 
    {
      ...
      chunk.tokens = (Token[])tokenList.toArray(new Token[0]);
