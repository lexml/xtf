...
public class BigramStopFilter extends TokenFilter 
{
   ...
   */
  public BigramStopFilter(TokenStream input, Set<String> stopSet)
  {
   ...
   */
  public static Set<String> makeStopSet(String stopWords)
  {
  ...
  public static final Object tester = new Object() 
  {
    ...
    private final Set<String> stopSet = new HashSet<>();
      ...
      throws IOException 
    {
      ...
      while (true) {
        ...
        if (t.getPositionIncrement() == 0)
          outBuf.append(',');
        outBuf.append(in, t.startOffset(), t.endOffset());
      }
