...
public abstract class ProgressTracker implements Cloneable 
{
  ...
  private final IntHolder prevPctDone = new IntHolder();
  private final LongHolder prevTime = new LongHolder();
  private final StringHolder prevDescrip = new StringHolder();
