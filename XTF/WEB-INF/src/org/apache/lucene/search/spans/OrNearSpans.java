...
{
  private final SpanOrNearQuery query;
  private Similarity similarity;
  private final int nClauses; // Number of original clauses
  private final ArrayList cells; // Spans in position order
  private final int slop; // from query
  private final boolean penalizeOutOfOrder; // from query
  ...
  private static class SpansCell
  {
    final Spans spans;
    final int index;
